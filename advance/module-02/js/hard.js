...
const tooBigAmount = `К сожалению, мест для столь большой группы нет. Максимальное число свободных мест в одной группе на данный момент составляет: ${maxAmount}`;
